...
// Projeto prático 2 da disciplina Sistemas Operacionais - SIN351 
...
int fifo(int8_t** page_table, int num_pages, int prev_page, int fifo_frm, int num_frames, int clock){ //algoritmo first in first out
	int i;
